  ...
  return (
    <div className="flex flex-col items-start text-left max-w-2xl">
      ...
      <motion.h1
        ...
        className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white to-white/70 mb-6 leading-[1.1]"
      >
